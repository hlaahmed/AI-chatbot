...
if ENV == 'dev':
    ...
    app.config[
        'SQLALCHEMY_DATABASE_URI'] = 'postgres://huzfmjptglbewt:28b2ede450d3da9185e2118f2a729dba6ac057dd94873f12071f3b1105384fdb@ec2-54-152-175-141.compute-1.amazonaws.com:5432/dqr71kkbtjnvk'
